(function () {
  ...
  function showAlreadySubmitted() {
    ...
    s.querySelector('p').textContent = 'We have your onboarding details for Reston. If something needs changing, email bill@velocityaipartners.ai and we will update it for you.';
    s.hidden = false;
  }
